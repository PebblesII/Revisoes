...
cidade_A = int(input("A quantidade da cidade menor: "))
print("-" * 50)
porcentageA = float(input("O percentual da Cidade menor: ")) / 100
print("-" * 50)

clear()

cidade_B = int(input("A quantidade da cidade maior: "))
print("-" * 50)
porcentageB = float(input("O percentual da Cidade maior: ")) / 100
print("-" * 50)

clear()

if cidade_A > cidade_B:
    print("Cidade A tem que ser Menor que Cidade B")
    exit()
if porcentageA < porcentageB:
    print("A porcentagem A tem que ser Maior que porcentagem B")

## Calculo

while cidade_A < cidade_B:
    print(f"Ano: {anos}")
    print(f"Cidade A: {cidade_A}")
    print(f"Cidade B: {cidade_B}")
    print("-" * 50)
    anos += 1
    tests += 1
    cidade_A += int(cidade_A * porcentageB)
    cidade_B += int(cidade_B * porcentageB)
    clear()
